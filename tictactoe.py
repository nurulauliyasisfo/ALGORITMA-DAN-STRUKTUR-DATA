...
def btnclick(buttons):
    ...
    if buttons['text'] == "" and bclick:
        ...
        tkinter.messagebox.showerror('TTC', 'Tidak valid! Pilih kotak lainnya.')
...
# Label pemain
Label(play, text='Pemain 1 (X)', font=('arial', 30), fg='RED').place(x=100, y=80)
Label(play, text='Pemain 2 (O)', font=('arial', 30), fg='GREEN').place(x=100, y=130)
